<?php 
class Cybercom_Import_Block_Adminhtml_Type_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  {   
      $this->addTab('form_section', array(
          ...
          'content'   => $this->getLayout()->createBlock('import/adminhtml_type_edit_tab_type')->toHtml(),
      ));
