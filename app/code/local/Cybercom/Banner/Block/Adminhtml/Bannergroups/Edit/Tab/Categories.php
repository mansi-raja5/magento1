<?php
class Cybercom_Banner_Block_Adminhtml_Bannergroups_Edit_Tab_Categories
    extends Mage_Adminhtml_Block_Catalog_Category_Tree {
    protected $_categoryIds = null;
    protected $_selectedNodes = null;
    public function __construct() {
        parent::__construct();
        $this->setTemplate('cybercom_banner/bannergroups/tab/edit/categories.phtml');
    ...
    public function getCategoryIds(){
        if (is_null($this->_categoryIds)){
            /*$categories = $this->getBannergroup()->getSelectedCategories();
                $ids = array();
