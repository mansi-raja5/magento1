...
class Cybercom_Banner_Block_Adminhtml_Bannergroups_Abstract extends Mage_Adminhtml_Block_Template
{
    ...
    {
        return Mage::registry('bannergroup');
    }

    public function getGroupId()
    {
        if ($this->getBannergroup()) {
            return $this->getBannergroup()->getId();
        }
        return 0;
    }
    ...
    {
        return $this->getBannergroup()->getName();
    }
