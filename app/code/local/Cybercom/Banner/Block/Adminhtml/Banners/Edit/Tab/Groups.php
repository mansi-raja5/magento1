<?php 
class Cybercom_Banner_Block_Adminhtml_Banners_Edit_Tab_Groups extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('cybercom_banner/banner/groups.phtml');
