<?php 
class Cybercom_Banner_Block_Adminhtml_Banners_Edit_Tab_Groupsb extends Cybercom_Banner_Block_Adminhtml_Bannergroups_Treegroups
{
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('cybercom_banner/banner/groupsb.phtml');
        $this->_withProductCount = false;
    }


    public function getGroups(){
        return Mage::registry('current_Groups'); //use other registration key if you have one
    }

    public function getCategoryIds(){
        if (is_null($this->_categoryIds)){
            $categories = $this->getGroups()->getSelectedCategories();
                $ids = array();
